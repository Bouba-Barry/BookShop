...
$livres = findLivreByCatName("la litterature");
?>
...
<body>
    ...
    <!-- <header>?php require_once '../Front/header.php'; ?></header> -->
    <!-- <section></section> -->
    <div class="container">
        <h1>Les Livres Litteraires Disponible</h1>
        <main class="grid">
